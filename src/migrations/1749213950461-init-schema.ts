...
export class InitSchema1749213950461 implements MigrationInterface {
    name = 'InitSchema1749213950461'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "telefone" varchar NOT NULL, "status" varchar NOT NULL, "password" varchar NOT NULL, "role" text NOT NULL DEFAULT ('ROLE_ADMIN'))`);
        await queryRunner.query(`CREATE TABLE "emprestimo" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "data_emprestimo" datetime NOT NULL DEFAULT (1749213952995), "data_devolucao_prevista" datetime NOT NULL, "data_devolucao_real" datetime NOT NULL, "status" text NOT NULL DEFAULT ('ativo'), "dias_atraso" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "livroId" integer, "usuarioId" integer, CONSTRAINT "REL_6a87b564046e0c3c735f5d21d9" UNIQUE ("livroId"), CONSTRAINT "REL_f9107b4941c5468328367938fc" UNIQUE ("usuarioId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_emprestimo" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "data_emprestimo" datetime NOT NULL DEFAULT (1749213952995), "data_devolucao_prevista" datetime NOT NULL, "data_devolucao_real" datetime NOT NULL, "status" text NOT NULL DEFAULT ('ativo'), "dias_atraso" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "livroId" integer, "usuarioId" integer, CONSTRAINT "REL_6a87b564046e0c3c735f5d21d9" UNIQUE ("livroId"), CONSTRAINT "REL_f9107b4941c5468328367938fc" UNIQUE ("usuarioId"), CONSTRAINT "FK_6a87b564046e0c3c735f5d21d98" FOREIGN KEY ("livroId") REFERENCES "livro" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_f9107b4941c5468328367938fc1" FOREIGN KEY ("usuarioId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
